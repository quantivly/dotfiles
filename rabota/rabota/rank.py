...
def _reply_key(n: dict) -> str:
    ...
    else the bare URL — never invented, but a ``pull/123`` URL is not an identifier, so it is
    reduced to the ``org/repo#123`` a reader already recognises from bucket 4."""
