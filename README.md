...
install's path into a file that's only regenerated by hand. (Quantivly's `dev-setup` writes this
line for you; see its docs for the account-routing side of SSH config.)
